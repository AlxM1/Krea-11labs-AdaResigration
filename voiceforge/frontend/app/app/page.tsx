      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {quickActions.map((action) => (
            <Link
              key={action.title}
              href={action.href}
              className="group relative overflow-hidden rounded-2xl bg-[#1f1f1f] border border-[#2f2f2f] p-6 hover:border-[#3f3f3f] transition"
            >
              ...
              <p className="text-sm text-[#a1a1a1]">{action.description}</p>
              <ArrowUpRight className="absolute top-6 right-6 w-5 h-5 text-[#666] group-hover:text-white transition" />
            </Link>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#1f1f1f] rounded-2xl border border-[#2f2f2f] p-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-[#0a0a0a] rounded-xl p-4">
                  <div className="flex items-center gap-2 text-[#a1a1a1] mb-2">
                    <FileAudio className="w-4 h-4" />
                    <span className="text-xs">Audio Generated</span>
                  </div>
                  <p className="text-2xl font-bold">{stats.audioGenerated}</p>
                ...
                <div className="bg-[#0a0a0a] rounded-xl p-4">
                  ...
                  <p className="text-2xl font-bold">{stats.voicesCreated}</p>
          ...
          <div className="space-y-6">
            {/* Current Plan */}
            <div className="bg-gradient-to-br from-[#7c3aed] to-[#db2777] rounded-2xl p-6">
            ...
            <div className="bg-[#1f1f1f] rounded-2xl border border-[#2f2f2f] p-6">
              ...
              <div className="space-y-2">
                <Link
                  href="/app/voices"
                  className="flex items-center justify-between p-3 hover:bg-[#2f2f2f] rounded-xl transition"
                >
